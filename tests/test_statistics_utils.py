...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_moving_average_basic_case(self):
        ...
        - Verificar que el resultado es correcto (ej: [1.5, 2.5, 3.5]
          para el array dado) (usar numpy.testing.assert_allclose() para 
          comparar arrays de NumPy - esto es mejor que unittest porque maneja la 
        ...
        (usar self.assertEqual para comparar tuplas de .shape - 
        comparación simple, unittest es suficiente)
        """
        utils = StatisticsUtils()
        arr = [1, 2, 3, 4]
    ...
    def test_moving_average_only_accepts_1d_sequences(self):
        ...
        - Llamar a moving_average con esa secuencia y 
        verificar que se lanza un ValueError indicando que solo 
